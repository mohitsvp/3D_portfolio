...
const ProjectCard = ({index, name, description, tags, image, source_code_link, features}) => {
  return (
    <motion.div
    ...
    >
      ...
      >
        <div className='relative w-full h-[230px]'>
          ...
          {name !== "Assess" ? <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
        ...
        <div className='mt-5'>
          ...
          <h4 className='text-white text-[20px] my-2'>Features</h4>
          {
            features && features.map((feature, index) => <ul key={index} className='list-disc px-5'>
              <li className='mt-2 text-secondary text-[14px]'>{feature}</li>
            </ul>)
          }
        </div>
...
const Works = () => {
  return (
    <>
      ...
      <div 
      className='mt-20 flex-wrap flex gap-7'>
